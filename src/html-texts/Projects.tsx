...
class ProjectsText {
    ...
    public static restaurant = "This a booking system for a restaurant. The restaurant needs a way to book and arrange tables for customers who whant to book. This system is for the staff and the customers to use.";
    public static checkers = "A checker games with both single and mutli player functionalities. This was a group project over the course of around 6 days.";
